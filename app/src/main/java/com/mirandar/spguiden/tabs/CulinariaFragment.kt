...
class CulinariaFragment(
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.culinaria_fragment, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val utils = Utils(context)
        val recyclerView = view.findViewById<RecyclerView>(R.id.recyclerCulinaria)
